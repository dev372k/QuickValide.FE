	...
	return (
		<main className='bg-slate-900 text-slate-50'>
			<div className='relative'>
				<nav className='p-3 px-6 text-sm flex items-center justify-between fixed w-full bg-slate-900 bg-opacity-20 backdrop-blur-sm z-20'>
				...
				<header className='p-3 px-6 w-full md:w-[22rem] lg:w-[47rem] mx-auto flex items-center justify-center min-h-screen flex-col gap-6'>
					...
					<button className='text-sm p-3 px-5 text-slate-900  border-2 border-slate-50 rounded-sm font-medium flex items-center gap-3 relative after:contents-[""] after:w-full after:h-full bg-slate-50 z-0 after:border-2 after:border-slate-50  after:absolute after:inset-0 after:-z-10 after:translate-y-2 after:translate-x-2 group'>
						Get started{" "}
				...
				<section className='py-16 md:py-32 px-6 w-full md:w-[22rem]  lg:w-[47rem] mx-auto flex flex-col gap-5 '>
					...
					<div className='text-sm flex flex-col gap-5 text-gray-600 leading-[1.5]'>
						<input
							...
							className='p-3 border-2 border-slate-50 bg-transparent text-slate-50 placeholder:text-slate-200'
						/>
						<button className='text-sm p-3 px-5 text-slate-900  border-2 border-slate-50 rounded-sm font-medium flex items-center justify-center gap-3 relative after:contents-[""] after:w-full after:h-full bg-slate-50 z-0 after:border-2 after:border-slate-50  after:absolute after:inset-0 after:-z-10 after:translate-y-2 after:translate-x-2 group'>
							Join
							<span className='group-hover:translate-x-1 transition-all'>
								&rarr;
							</span>
				...
				<section className='py-16 md:py-32 px-6 w-full md:w-[22rem]  lg:w-[47rem] mx-auto flex flex-col gap-5 '>
					...
					<div className='text-sm flex flex-col gap-5 text-slate-100 leading-[1.5]'>
						<p>
				...
				<section className='py-16 md:py-32 w-full md:w-[22rem] lg:w-[47rem] mx-auto flex flex-col gap-5 '>
					...
					<div className='text-sm gap-8 leading-[1.5] grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] px-6'>
						<div className='text-sm p-6 flex flex-col gap-8 border-2 border-slate-50 '>
							...
							<button className='text-sm p-3 px-5 text-slate-900  border-2 border-black rounded-sm font-medium flex items-center justify-center gap-3 relative after:contents-[""] after:w-full after:h-full bg-slate-50 z-0 after:border-2 after:border-slate-50   after:absolute after:inset-0 after:-z-10 after:translate-y-2 after:translate-x-2 group'>
								Subscribe
							</button>
