...
function Login() {
  ...
  return (
    <main className="w-full min-h-screen flex items-center justify-center px-4 md:px-6">
      ...
      <div className="flex md:w-[30rem] flex-col gap-5 px-5 py-8 rounded-lg border-[1px] border-gray-300 w-[90%] sm:w-[25rem]">
            ...
            <div>
              <div className="flex items-center w-full relative">
                <input
                  ...
                  className="p-3 border-[1px] border-gray-200 rounded-md w-full mr-auto"
                  {...register("password", {
