...
const clientId = '933017194074-dp2kaj9jolvebu8u14uluqms0mibj9e2.apps.googleusercontent.com';
...
function Login() {
    ...
    async function onSubmit(data) {
        setIsLoading(true);
        const res = await request('https://api.quickvalide.com/api/Auth/login', 'POST', data);
        setIsLoading(false);
