...
function Theme1() {
    ...
    return (
        <main className=''>
            <div className=''>
                <nav className='p-3 px-6 text-sm flex items-center justify-between sticky left-0 right-0 top-0 w-full bg-white bg-opacity-20 backdrop-blur-sm z-20'>
                ...
                <section className='py-16 md:py-32 px-6 w-full md:w-[22rem]  lg:w-[47rem] mx-auto flex flex-col gap-5 '>
                    ...
                    <div className='text-sm flex flex-col gap-5 text-gray-600 leading-[1.5]'>
                        <p className='text-center'>{themeData.aboutUs.text}</p>
                    </div>
                </section>
