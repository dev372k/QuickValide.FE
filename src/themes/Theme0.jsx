			...
			<header className='w-full md:max-w-[25rem] px-8 lg:max-w-[55rem] leading-[1.2] tracking-tighter font-medium mx-auto text-3xl md:text-4x lg:text-7xl text-center min-h-[80vh] flex flex-col gap-8 items-center justify-center'>
				<div className='flex flex-col gap-5 items-center'>
					...
					<p className='text-sm leading-[1.7] tracking-wide text-text-secondary'>
						...
						odio eveniet inventore tempora hic suscipit sequi dolore optio
						voluptatum, modi veniam amet. Corrupti voluptatem inventore saepe,
						expedita, ratione commodi obcaecati repellendus reprehenderit
						voluptatibus officiis esse enim.
					</p>
				</div>
				...
				<div className='w-full md:max-w-[25rem] lg:max-w-[55rem] mx-auto text-center flex flex-col gap-4 px-8'>
					...
					<div className='flex flex-col gap-2 text-text-secondary'>
						<p>
							...
							quis quasi itaque accusantium repellat sint saepe cumque harum
							nesciunt, impedit officiis libero ipsa consectetur magni sapiente
							architecto laborum inventore. Sed!
						</p>
						<p>
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste eos
							velit illo expedita sint quaerat sed soluta laudantium odio,
							reiciendis quae animi similique reprehenderit debitis, ex unde
							totam tempora quam id fugit, laborum possimus suscipit!
						</p>
					</div>
				</div>
			</section>
